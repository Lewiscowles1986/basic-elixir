...
config :basic, BasicWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "Ynmw3+vI8GOcTMZ2jaUsDAOAqxie1S+Y7bWN9tOBKLjWgNiPM3DBbRZv6aG7KGQF",
  watchers: [
...
config :basic, BasicWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/basic_web/router\.ex$"E,
      ~r"lib/basic_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
